...
<template>
  <div :class="['relative w-full max-w-4xl mx-auto h-[700px] flex flex-col transition-all duration-700 overflow-hidden rounded-[2.5rem] shadow-[0_15px_60px_rgb(0,0,0,0.15)] my-20 border', darkMode ? 'bg-[#0b1120] text-slate-200 border-slate-800' : 'bg-slate-50 text-slate-800 border-slate-200']">
