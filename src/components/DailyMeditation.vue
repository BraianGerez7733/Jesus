...
<template>
  <div :class="['relative w-[90%] md:w-full md:max-w-4xl lg:max-w-5xl mx-auto h-[650px] flex flex-col transition-all duration-700 overflow-hidden rounded-[2.5rem] shadow-2xl my-20 border', darkMode ? 'bg-[#0b1120] text-slate-200 border-slate-800' : 'bg-slate-50 text-slate-800 border-slate-200']">
